          ...
          <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 px-8 py-6 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Assign Imli</h1>
                  <p className="text-orange-100 text-sm font-medium">Distribute raw imli to local workers</p>
                </div>
              </div>
            ...
            {fetchingLocals ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-500 text-sm mt-2 ml-1">Start typing to search for local workers</p>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      step="0.01"
                      min="0"
                      placeholder="Enter quantity in kilograms (e.g., 25.50)"
                  ...
                  <p className="text-gray-500 text-sm mt-2 ml-1">Enter the amount of raw imli to assign</p>
                </div>
