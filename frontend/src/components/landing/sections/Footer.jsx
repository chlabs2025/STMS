...
const Footer = () => {
    return (
        <footer className="bg-zinc-900 text-gray-400 py-16">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">

                    {/* Brand */}
                    <div className="col-span-1 md:col-span-1">
                        <span className="text-2xl font-bold text-white block mb-6">
                            Super Imli<span className="text-orange-500">.</span>
                        </span>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
                    <p>&copy; 2024 Super Imli Traders. All rights reserved.</p>
