...
export default function CustomerDetails({ formData, updateFormData, onNext, onBack }) {
    ...
    return (
        <div className="space-y-8">
            {/* Section Title */}
            <div>
                <h3 className="text-xl font-bold text-gray-900 mb-1">Customer Details</h3>
                <p className="text-gray-500 text-sm font-medium">Enter the buyer / bill-to information</p>
            </div>
